      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-blue font-roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normal lg:text-left">
            Dapatkan cerita dari kami, dikirimkan ke kotak masuk anda setiap minggu.
            </h2>
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              ...
              <button className="bg-blue-500 px-4 py-3 rounded-lg w-full bg-primary text-white font-bold md:w-fit ">
                Subscribe
              </button>
            </div>
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
              Dapatkan informasi terkini seputar layanan kesehatan terbaik kami dan cerita inspiratif dari kami.
            </p>
          </div>
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last">
            <div className="w-3/4 mx-auto relative">
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                ...
                />
                <div className="p-5">
                  <h2 className="font-roboto font-bold text-xl text-cyan-500-soft md:text-2xl lg:text-[28px]">
